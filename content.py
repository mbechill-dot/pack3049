...
<section class="section">
  <div class="wrap">
    ...
    <div class="grid grid--2">
      <div class="card card--accent">
        <h3>Michael Bechill</h3>
        <p class="muted" style="margin-top:-.5rem"><strong>Committee Chair</strong></p>
        <p>The pack's top volunteer role. Registration paperwork, the budget, popcorn, and camp logistics.</p>
        <p class="muted">Reach him through the pack inbox below, or catch him on a Monday night.</p>
      </div>
      <div class="card card--accent">
        <h3>Nicole Howard</h3>
      ...
      <div>
        ...
        <ul class="leader-list">
          <li><span class="role">Committee Chair</span><span class="name">Michael Bechill</span><br>
            <span class="muted">The pack's top volunteer role. Registration paperwork, the budget, popcorn, and camp logistics.</span></li>
          ...
          <li><span class="role">Treasurer</span><span class="name">Kirk Smith</span></li>
          ...
          <li><span class="role">Popcorn Kernel</span><span class="name">Michael Bechill</span><br>
            <span class="muted">Assistant Kernel: Tammy Swanson. Both roles turn over after the 2026 season, see below.</span></li>
          <li><span class="role">Camp Coordinator</span><span class="name">Seth Hughes</span></li>
          ...
          <li><span class="role">Den Leaders and Assistants</span><span class="name">One pair per den</span><br>
            <span class="muted">Tigers, Wolves, Bears, Webelos, and Arrow of Light. The Lion den leader position is
            currently open. See <a href="#dens">the dens</a> above.</span></li>
