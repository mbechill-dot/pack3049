  ...
  <div class="wrap">
    <div class="grid grid--2">
      <div>
        ...
        <p>Badges, belt loops, pinewood derby cars, campfire wood, pack camping gear, the Blue and Gold banquet, awards, craft supplies, and the pack's share of camp. It adds up to a real annual budget, and it works out to about <strong>$222 of programming per Scout, per year</strong>, on top of what you pay to register.</p>
        ...
        <div class="alert">
          ...
          <p><strong>Popcorn pays for everything else</strong>: about <strong>$222 per Scout</strong> of programming, plus the council and national fees your $100 does not cover. A Scout year truly costs about $376. You pay $100. Popcorn closes the gap.</p>
        </div>
      ...
      <div>
        <div class="card card--accent">
          ...
          <div class="rows">
            ...
            <div><span class="k">True cost of a year</span><span class="v">About $376 per Scout<small>$85 national, $54 council, $15 Scout Life, about $222 pack programming</small></span></div>
            <div><span class="k">Buyout</span><span class="v">$300 per Scout<small>Instead of selling. Or any mix of the two. Due December 1</small></span></div>
            <div><span class="k">Sales goal</span><span class="v">$525 per Scout<small>Exactly one starter pack. Due December 1</small></span></div>
...
<section class="section section--tint">
  <div class="wrap">
    ...
    <h3 style="margin-top:2.5rem">What a Scout year actually costs</h3>
    <p>Not an estimate. These are the figures presented at the August 31 kickoff, and the full
       minutes are linked at the bottom of this page.</p>
    <div class="table-scroll">
      <table>
        <caption class="visually-hidden">True cost of a Cub Scout year in Pack 3049</caption>
        <thead><tr><th scope="col">What it is</th><th scope="col">Per Scout, per year</th><th scope="col">Who it goes to</th></tr></thead>
        <tbody>
          <tr><td>Scouting America national registration</td><td>$85</td><td>National. Not ours, and we cannot discount it.</td></tr>
          <tr><td>Anthony Wayne Area Council fee</td><td>$54</td><td>Local camps, training, district events, the Scout Shop</td></tr>
          <tr><td><em>Scout Life</em> magazine</td><td>$15</td><td>Mailed to your house. The pack covers it.</td></tr>
          <tr><td>Pack programming</td><td>About $222</td><td>Badges, derby, camping, craft supplies, awards, Blue and Gold</td></tr>
          <tr><td><strong>True cost of a Scout year</strong></td><td><strong>About $376</strong></td><td><strong>What it actually takes to run one Scout for a year</strong></td></tr>
          <tr><td><strong>What your family pays</strong></td><td><strong>$100</strong></td><td><strong>The pack registration fee, August through April</strong></td></tr>
          <tr><td><strong>The gap</strong></td><td><strong>About $276</strong></td><td><strong>Covered by popcorn. Every dollar of it.</strong></td></tr>
        </tbody>
      </table>
    </div>
    <p class="muted">The pack's whole annual budget is a little over $25,000. At this year's commission
       rate that takes roughly $66,000 in sales to break even, which is why the sale matters as much as
       it does.</p></section>
...
<section class="section">
  <div class="wrap">
    ...
    <ul class="products">
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 2 tbsp (30g) &middot; 110 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>1g</dd></div>
                <div><dt>Saturated fat</dt><dd>0g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>0mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>22g</dd></div>
                <div><dt>Dietary fiber</dt><dd>5g</dd></div>
                <div><dt>Total sugars</dt><dd>0g</dd></div>
                <div><dt>Added sugars</dt><dd>0g</dd></div>
                <div><dt>Protein</dt><dd>3g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Yellow popping corn.</p>
              <p class="nut__contains"><strong>Contains:</strong> No allergens listed.</p>
            </div>
          </details>
        </div>
      </li>
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 3/4 cup (30g) &middot; 120 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>4g</dd></div>
                <div><dt>Saturated fat</dt><dd>1g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>20mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>21g</dd></div>
                <div><dt>Dietary fiber</dt><dd>1g</dd></div>
                <div><dt>Total sugars</dt><dd>15g</dd></div>
                <div><dt>Added sugars</dt><dd>15g</dd></div>
                <div><dt>Protein</dt><dd>1g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Brown sugar, popcorn, corn syrup, white sugar, corn oil, water, butter (cream, salt), soy lecithin, baking soda, salt, natural flavor.</p>
              <p class="nut__contains"><strong>Contains:</strong> Milk, soy. Processed in a facility that also processes peanuts and tree nuts.</p>
            </div>
          </details>
        </div>
      </li>
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 2 cups (28g) &middot; 170 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>14g</dd></div>
                <div><dt>Saturated fat</dt><dd>6g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>200mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>10g</dd></div>
                <div><dt>Dietary fiber</dt><dd>3g</dd></div>
                <div><dt>Total sugars</dt><dd>2g</dd></div>
                <div><dt>Added sugars</dt><dd>0g</dd></div>
                <div><dt>Protein</dt><dd>2g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Popcorn, coconut and/or vegetable oil (canola, corn, sunflower oil), cheddar cheese (cultured milk, salt, enzymes, whey, buttermilk, salt, natural flavor, disodium phosphate, lactic acid, silicon dioxide), paprika, natural flavor.</p>
              <p class="nut__contains"><strong>Contains:</strong> Milk. Processed in a facility that also processes soy, peanuts and tree nuts.</p>
            </div>
          </details>
        </div>
      </li>
        ...
        <div class="product__body">
          ...
          <details class="nut">
            ...
            <div class="nut__body">
              <p class="nut__serve">Serving size 2 cups (28g) &middot; 170 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>13g</dd></div>
                <div><dt>Saturated fat</dt><dd>5g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>220mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>10g</dd></div>
                <div><dt>Dietary fiber</dt><dd>3g</dd></div>
                <div><dt>Total sugars</dt><dd>1g</dd></div>
                <div><dt>Added sugars</dt><dd>0g</dd></div>
                <div><dt>Protein</dt><dd>2g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Popcorn, coconut and/or vegetable oil (canola, corn, sunflower oil), cheddar cheese (cultured milk, salt, enzymes), whey, buttermilk, salt, natural flavor, disodium phosphate, lactic acid, silicon dioxide, maltodextrin, dehydrated jalapeno pepper, salt, monosodium glutamate, whey, cheddar and blue cheese blend (milk, salt, cultures, enzymes), onion powder, soybean oil, reduced lactose whey, natural flavor, citric acid, FD&amp;C Yellow #6, disodium phosphate, nonfat dry milk, FD&amp;C Yellow #5, disodium inosinate and guanylate, natural spice, extractives of turmeric and paprika, paprika, natural flavor.</p>
              <p class="nut__contains"><strong>Contains:</strong> Milk. Processed in a facility that also processes soy, peanuts and tree nuts.</p>
            </div>
          </details>
        </div>
      ...
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 1/4 cup (30g) &middot; 150 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>10g</dd></div>
                <div><dt>Saturated fat</dt><dd>2g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>75mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>12g</dd></div>
                <div><dt>Dietary fiber</dt><dd>2g</dd></div>
                <div><dt>Total sugars</dt><dd>3g</dd></div>
                <div><dt>Added sugars</dt><dd>2g</dd></div>
                <div><dt>Protein</dt><dd>5g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Peanuts, raisins, M&amp;M'S milk chocolate candies (milk chocolate [sugar, chocolate, skim milk, cocoa butter, lactose, milkfat, soy lecithin, salt, natural flavor], sugar, cornstarch, less than 1% of: corn syrup, dextrin, colors, carnauba wax, gum acacia), almonds, cashews, vegetable oil (peanut and/or soy), salt.</p>
              <p class="nut__contains"><strong>Contains:</strong> Peanuts, almonds, cashews, soy, milk. May contain Brazil nuts, filberts (hazelnuts), macadamia nuts, pecans, pistachios, walnuts. May contain an occasional pit or shell fragment.</p>
            </div>
          </details>
        </div>
      </li>
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 1 cup popped (8g) &middot; 35 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>2g</dd></div>
                <div><dt>Saturated fat</dt><dd>1g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>75mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>4g</dd></div>
                <div><dt>Dietary fiber</dt><dd>1g</dd></div>
                <div><dt>Total sugars</dt><dd>0g</dd></div>
                <div><dt>Added sugars</dt><dd>0g</dd></div>
                <div><dt>Protein</dt><dd>1g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Popcorn, palm oil, salt, butter flavor (maltodextrin, food starch-modified, milk fat, natural flavors, tocopherols), annatto extract, natural flavor.</p>
              <p class="nut__contains"><strong>Contains:</strong> Milk.</p>
            </div>
          </details>
        </div>
      </li>
          ...
          <details class="nut">
            ...
            <div class="nut__body">
              ...
              <dl class="nut__grid">
                ...
                <div><dt>Saturated fat</dt><dd>1g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>55mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>4g</dd></div>
                <div><dt>Dietary fiber</dt><dd>1g</dd></div>
                <div><dt>Total sugars</dt><dd>0g</dd></div>
                <div><dt>Added sugars</dt><dd>0g</dd></div>
              ...
              <p class="nut__ing"><strong>Ingredients:</strong> Popcorn, palm oil, salt, sucralose.</p>
              <p class="nut__contains"><strong>Contains:</strong> No allergens listed.</p>
            </div>
          </details>
        </div>
          ...
          <details class="nut">
            ...
            <div class="nut__body">
              ...
              <dl class="nut__grid">
                ...
                <div><dt>Saturated fat</dt><dd>1g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>150mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>21g</dd></div>
                <div><dt>Dietary fiber</dt><dd>1g</dd></div>
                <div><dt>Total sugars</dt><dd>15g</dd></div>
                <div><dt>Added sugars</dt><dd>15g</dd></div>
              ...
              <p class="nut__ing"><strong>Ingredients:</strong> Brown sugar, popcorn, corn syrup, white sugar, corn oil, water, butter (cream, salt), sea salt, soy lecithin, baking soda, salt, natural flavor.</p>
              <p class="nut__contains"><strong>Contains:</strong> Milk, soy. Processed in a facility that also processes peanuts and tree nuts.</p>
            </div>
          </details>
        </div>
      ...
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 1/2 cup (30g) &middot; 130 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>5g</dd></div>
                <div><dt>Saturated fat</dt><dd>3g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>200mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>20g</dd></div>
                <div><dt>Dietary fiber</dt><dd>1g</dd></div>
                <div><dt>Total sugars</dt><dd>15g</dd></div>
                <div><dt>Added sugars</dt><dd>15g</dd></div>
                <div><dt>Protein</dt><dd>1g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Caramel corn (brown sugar, white sugar, popcorn, corn syrup, corn oil, water, butter (cream, salt), soy lecithin, baking soda, natural flavor), milk wafers (sugar, vegetable oil (palm kernel oil and hydrogenated palm kernel oil), cocoa powder, nonfat dry milk solids, whole milk solids, whey powder, soy lecithin, salt and artificial flavor), sea salt, natural flavor, peanut oil, almond oil and cashew oil.</p>
              <p class="nut__contains"><strong>Contains:</strong> Milk, soy, peanuts and tree nuts.</p>
            </div>
          </details>
        </div>
      </li>
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 1/2 cup (28g) &middot; 120 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>5g</dd></div>
                <div><dt>Saturated fat</dt><dd>2.5g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>115mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>19g</dd></div>
                <div><dt>Dietary fiber</dt><dd>1g</dd></div>
                <div><dt>Total sugars</dt><dd>15g</dd></div>
                <div><dt>Added sugars</dt><dd>15g</dd></div>
                <div><dt>Protein</dt><dd>1g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> Caramel corn (brown sugar, white sugar, popcorn, corn syrup, corn oil, water, butter (cream, salt), sea salt, soy lecithin, baking soda, natural flavor), milk wafer (sugar, vegetable oil (palm kernel oil and hydrogenated palm kernel oil), cocoa powder, nonfat dry milk solids, whole milk solids, whey powder, soy lecithin, salt, and artificial flavor), white wafer (sugar, vegetable oil (palm kernel oil and hydrogenated palm kernel oil), whey powder, whole milk solids, nonfat dry milk solids, soy lecithin, salt, and artificial flavor), natural flavor, peanut oil, almond oil, cashew oil.</p>
              <p class="nut__contains"><strong>Contains:</strong> Soy, peanuts, milk, tree nuts.</p>
            </div>
          </details>
        </div>
      </li>
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">Serving size 4 pieces (28g) &middot; 140 calories</p>
              <dl class="nut__grid">
                <div><dt>Total fat</dt><dd>6g</dd></div>
                <div><dt>Saturated fat</dt><dd>3.5g</dd></div>
                <div><dt>Trans fat</dt><dd>0g</dd></div>
                <div><dt>Sodium</dt><dd>220mg</dd></div>
                <div><dt>Total carbohydrate</dt><dd>19g</dd></div>
                <div><dt>Dietary fiber</dt><dd>0g</dd></div>
                <div><dt>Total sugars</dt><dd>10g</dd></div>
                <div><dt>Added sugars</dt><dd>9g</dd></div>
                <div><dt>Protein</dt><dd>2g</dd></div>
              </dl>
              <p class="nut__ing"><strong>Ingredients:</strong> White chocolate (sugar, cocoa butter, whole milk powder, nonfat dry milk, butterfat, soy lecithin, vanilla extract), pretzels (enriched wheat flour [contains ferrous sulfate, niacin, thiamin mononitrate, riboflavin, folic acid, corn syrup, salt, vegetable oil (may contain one or more of the following: canola, corn, soybean), malt syrup, sodium bicarbonate, yeast]). Contains less than 2% of colors (spirulina extract, vegetable juice color, annatto extract), medium chain triglycerides, sunflower lecithin.</p>
              <p class="nut__contains"><strong>Contains:</strong> Soy, wheat, milk. May contain peanuts, almonds, cashews, filberts (hazelnuts), macadamia nuts, pecans, pistachios, walnuts.</p>
            </div>
          </details>
        </div>
      </li>
      <li class="product">
        ...
        <div class="product__body">
          ...
          <details class="nut">
            <summary>Nutrition and ingredients</summary>
            <div class="nut__body">
              <p class="nut__serve">A mixed tin, not one flavor</p>
              <p>Check the tin for which cheeses are inside, then read those panels. Every cheese flavor
                 Pecatonica River makes is <strong>2 cups (28g) per serving, 170 calories</strong>, and
                 every one <strong>contains milk</strong>.</p>
              <dl class="nut__grid">
                <div><dt>Cheddar Cheese</dt><dd>14g fat &middot; 200mg sodium</dd></div>
                <div><dt>White Cheddar</dt><dd>14g fat &middot; 200mg sodium</dd></div>
                <div><dt>Jalapeno Cheese</dt><dd>13g fat &middot; 220mg sodium</dd></div>
              </dl>
              <p class="nut__contains"><strong>Contains:</strong> Milk. Processed in a facility that also
                 processes soy, peanuts and tree nuts.</p>
            </div>
          </details>
        </div>
      </li>
    ...
    <div class="callout callout--info">
      <p><strong>Tap "Nutrition and ingredients" on any product</strong> for the full panel: serving size, calories, fat, sodium, sugars, protein, the complete ingredient list, and the allergen statement. It is here because families ask, and because several Scouts in this pack have nut allergies.</p>
      <p><strong>Always read the actual package before serving.</strong> This is transcribed from Pecatonica River Popcorn as of September 2026. The pack is not the manufacturer, formulations change, and the label on the tin in your hand is the one that counts. <a href="https://pecatonicariverpopcorn.com/nutrition-information/">PRP nutrition information</a>.</p>
...
<section class="section" id="advertising">
  <div class="wrap">
    <span class="eyebrow">The fun part</span>
    <h2>Make the stand your own</h2>
    <div class="grid grid--2" style="align-items:start;margin-top:1.25rem">
      <div>
        <p style="font-size:1.12rem">Signs, price tags, a donation jar, decorations. Let your Scout
           build the stand they want and put their name on it. A table a kid decorated themselves sells
           better than a folding table with a box on it, and they know it.</p>
        <p>We have put together printables you can use as they are, or mix in with whatever your Scout
           comes up with. Print them, cut them out, tape them up.</p>
        <p><strong>Mostly, have fun with it.</strong> A popcorn stand is a Scout practicing confidence,
           talking to strangers, being creative, and running a tiny business. The popcorn is almost the
           side project.</p>
        <div class="docs" style="margin-top:1.25rem">
          <a class="doc" href="docs/pack3049-popcorn-advertising-kit.pdf">
            <span class="doc__type" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M6 9V2h12v7"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/>
                <path d="M6 14h12v8H6z"/></svg>
            </span>
            <span class="doc__text"><b>Print the advertising kit</b><em>PDF &middot; 7 pages</em></span>
          </a>
        </div>
      </div>
      <div>
        <figure class="adkit">
          <img src="images/advertising-kit-preview.jpg" width="1342" height="420" loading="lazy" alt="Four pages from the Pack 3049 advertising kit: a popcorn sale poster listing all ten products with prices and allergens, a Donations to Pack 3049 Are Welcome poster showing what donations pay for, a Cub Scouts Pack 3049 Leo Indiana logo sheet, and a page of cut-out price tags.">
          <figcaption>What is inside</figcaption>
        </figure>
        <ul class="checklist checklist--yes">
          <li><strong>Popcorn sale poster</strong> with all ten products, prices, and allergens</li>
          <li><strong>Donations welcome poster</strong> showing what a donation actually pays for</li>
          <li><strong>Two donation jar signs</strong>, ready to cut out</li>
          <li><strong>Pack 3049 logo sheet</strong> for the front of the table</li>
          <li><strong>Cut-out price tags</strong> for every price: $15, $20, $25, and $30</li>
        </ul>
        <p class="muted">Prints on plain letter paper. Cardstock holds up better outdoors, and a sheet
           protector or packing tape keeps a sign alive through a windy Saturday.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section section--tint">
  <div class="wrap">
    ...
    <div class="grid grid--3">
      ...
      <div class="card card--accent"><h3>Buyout</h3><p><strong>$300</strong> instead of selling, or any combination of sales and buyout. Due December 1. No guilt, no follow up, no explanation needed. The $100 registration fee is separate and still applies.</p></div>
...
<section class="section">
  <div class="wrap">
    <div class="bigevent" id="home-church" style="margin-bottom:2.25rem">
      <span class="eyebrow">Where we meet</span>
      <h2>Cedar Creek Church</h2>
      <div class="grid grid--2" style="align-items:start">
        <div>
          <p style="font-size:1.15rem"><strong>Mondays at 6:30 PM during the school year.</strong>
             Walk in, ask for a Cub Scout leader, and someone will find you. First night is free and
             there is nothing to bring.</p>
          <p><strong><a href="https://cedarcreekchurch.com">Cedar Creek Church</a></strong><br>
             12606 Leo Road<br>Fort Wayne, IN 46845</p>
          <div class="btn-row">
            <a class="btn btn--primary" href="https://maps.google.com/?q=12606+Leo+Rd,+Fort+Wayne,+IN+46845">Get directions</a>
            <a class="btn btn--solid" href="https://cedarcreekchurch.com">Visit their site</a>
          </div>
        </div>
        <div>
          <p>Cedar Creek Church hosts Pack 3049. They give us the room every Monday night, the space to
             run pack meetings, build derby cars, and hold the Blue and Gold banquet, and they have done
             it without asking for anything back.</p>
          <p>A pack does not run without somewhere to meet. <strong>They are the reason we have one.</strong></p>
          <p class="muted">Cedar Creek is our meeting home. Our chartered organization is a separate
             thing, and that is <a href="#charter">American Legion Post 409</a>, further down this page.</p>
        </div>
      </div>
    </div>

    <span class="eyebrow">Start here</span>
    <h2>Talk to a Cubmaster</h2>
    <p class="muted" style="max-width:64ch">Either one can answer anything. Call, text, or email whichever
       you reach first, and they will pull in whoever else is needed.</p>
    <div class="grid grid--2" style="margin-top:1.5rem">
      ...
      <div class="card card--accent">
        ...
        <p class="muted">Questions about joining, dens, camp, popcorn, money, or anything else. Start here.</p>
      </div>
    </div>
  </div>
</section>

<section class="section section--tint" id="dens">
  <div class="wrap">
    <span class="eyebrow">The dens</span>
    <h2>Who your Scout meets on a Monday</h2>
    <p class="muted" style="max-width:66ch">Cub Scouts is run by grade. Your Scout joins the den that matches
       the grade they are in this year and moves up with the same group of kids every August. Each den has a
       den leader and an assistant den leader.</p>
    <div class="dens">
      <div class="den" style="--den:#ffc93c">
        <span class="den__grade">Kindergarten</span>
        <h3>Lions</h3>
        <p>Their first year. Everything is done shoulder to shoulder with a grown-up, so a parent stays for the meeting.</p>
<p class="den__lead"><strong>Den leader position is open.</strong> Until it is filled, the Cubmasters run this den. If your Scout is a Lion, this is the job that would help most.</p>
      </div>
      <div class="den" style="--den:#ff6b35">
        <span class="den__grade">1st grade</span>
        <h3>Tigers</h3>
        <p>Still with an adult partner, but starting to run at things on their own. First campout, first derby car.</p>
<p class="den__lead">Den leader and assistant den leader. You will meet both on your Scout's first night.</p>
      </div>
      <div class="den" style="--den:#3f8f5f">
        <span class="den__grade">2nd grade</span>
        <h3>Wolves</h3>
        <p>The year it clicks. Knots, hikes, and the first badges they earn without a grown-up hovering.</p>
<p class="den__lead">Den leader and assistant den leader. You will meet both on your Scout's first night.</p>
      </div>
      <div class="den" style="--den:#8a5a2b">
        <span class="den__grade">3rd grade</span>
        <h3>Bears</h3>
        <p>Tools, fires, and bigger adventures. This is where Scouts start teaching the younger dens.</p>
<p class="den__lead">Den leader and assistant den leader. You will meet both on your Scout's first night.</p>
      </div>
      <div class="den" style="--den:#00808c">
        <span class="den__grade">4th grade</span>
        <h3>Webelos</h3>
        <p>Getting ready for Scouts BSA. More responsibility, more say in what the den does.</p>
<p class="den__lead">Den leader and assistant den leader. You will meet both on your Scout's first night.</p>
      </div>
      <div class="den" style="--den:#123021">
        <span class="den__grade">5th grade</span>
        <h3>Arrow of Light</h3>
        <p>The last Cub year and the highest Cub rank. They cross over to a troop in the spring.</p>
<p class="den__lead">Den leader and assistant den leader. You will meet both on your Scout's first night.</p>
      </div>
    </div>
    <p class="muted" style="margin-top:1.5rem">Den leaders are parents. Every one of them started out
       knowing nothing about Scouting, and the training is free and mostly online.
       <a href="register.html#adult">Volunteering starts here</a>.</p>
  </div>
</section>
...
<section class="section">
  <div class="wrap">
    <div class="grid grid--2">
      <div>
        ...
        <ul class="leader-list">
          <li><span class="role">Committee Chair</span><span class="name">Michael Bechill</span><br>
            <span class="muted">Leads the pack committee, recruits qualified volunteers, and handles administration.</span></li>
          <li><span class="role">Co-Cubmaster</span><span class="name">Nicole Howard</span><br>
            <a href="tel:+12605572243">(260) 557-2243</a> &middot; <a href="mailto:howardfamily411@gmail.com">howardfamily411@gmail.com</a><br>
            <span class="muted">Emcees the monthly pack meetings, supports den leaders, and coordinates the overall program.</span></li>
          <li><span class="role">Co-Cubmaster</span><span class="name">Dan Noll</span><br>
            <a href="tel:+12606025134">(260) 602-5134</a> &middot; <a href="mailto:steelers6615@gmail.com">steelers6615@gmail.com</a><br>
            <span class="muted">Emcees the monthly pack meetings, supports den leaders, and coordinates the overall program.</span></li>
          <li><span class="role">Assistant Cubmaster</span><span class="name">Nick Schall</span><br>
            <span class="muted">Helps the Cubmaster run meetings and events, and stands in when needed.</span></li>
          <li><span class="role">Treasurer</span><span class="name">Kirk Smith</span><br>
            <span class="muted">Manages the pack budget, accounts, and finances.</span></li>
          <li><span class="role">Secretary</span><span class="name">Dan Noll</span><br>
            <span class="muted">Takes meeting notes and handles pack correspondence.</span></li>
          <li><span class="role">Popcorn Kernel</span><span class="name">Michael Bechill</span><br>
            <span class="muted">Coordinates the annual product sale and money-earning projects.
            Assistant Kernel: Tammy Swanson. Both roles turn over after the 2026 season, see below.</span></li>
          <li><span class="role">Camp Coordinator</span><span class="name">Seth Hughes</span><br>
            <span class="muted">Runs summer camp: sign-ups, forms, packing lists, and the week itself.</span></li>
          <li><span class="role">Assistant Camp Coordinator</span><span class="name">Open</span><br>
            <span class="muted">Help plan and run summer camp alongside Seth. A good first volunteer job, and you go to camp anyway.</span></li>
          <li><span class="role">Den Leaders and Assistants</span><span class="name">One pair per den</span><br>
            <span class="muted">The den leader runs regular meetings for one grade and guides Scouts through their
            handbook adventures. The assistant helps manage the den and supervise activities. Tigers, Wolves,
            Bears, Webelos, and Arrow of Light are covered; the Lion den leader position is currently open.
            See <a href="#dens">the dens</a> above.</span></li>
          <li><span class="role">We are looking for help with</span><span class="name">Lion Den Leader, Assistant Camp Coordinator, Pack Trainer, Assistant Treasurer, Advancement Coordinator</span><br>
        ...
        <div class="alert" style="margin-top:1.5rem">
          <h3>Wanted: the next Popcorn Kernel, and an assistant</h3>
          <p>Popcorn pays for everything this pack does, and after the 2026 season both the Kernel and the
             Assistant Kernel roles open up for <strong>2027 and 2028</strong>.</p>
          <p><strong>The ask is that you start now, not next August.</strong> Shadow this year's sale, see how
             the order gets built, how the trailer gets unloaded, how storefronts get booked and how the money
             comes in. Then run it next year already knowing what you are doing, instead of learning it cold
             in the middle of a season.</p>
          <p>Two people, so nobody carries it alone. If you have ever thought you might want a bigger role in
             this pack, this is the one that matters most. Talk to Michael Bechill or either Co-Cubmaster.</p>
        </div>
      ...
      <div>
        <h2 id="charter">Our chartered organization</h2>
        <p class="muted">Different from our meeting place. <a href="#home-church">Cedar Creek Church</a> hosts us; Post 409 charters us.</p>
        <div class="card card--accent">
...
<section class="section">
  <div class="wrap">
    ...
    <h2>Every job in the pack, explained</h2>
    <p class="muted" style="max-width:68ch">A pack runs entirely on parent volunteers, and most families have
       no idea what these titles actually mean. Here is the plain version. If any of them sounds like something
       you could do, that is how most of us started.</p>

    <h3 style="margin-top:2rem">Leading the program</h3>
    <p class="muted">The people in front of the Scouts.</p>
    <div class="role-defs">
        <div class="role-def"><h4>Cubmaster</h4><p>Emcees the monthly pack meetings, supports den leaders, and coordinates the overall program.</p></div>
        <div class="role-def"><h4>Assistant Cubmaster</h4><p>Helps the Cubmaster run meetings and events, and stands in when needed.</p></div>
        <div class="role-def"><h4>Den Leader</h4><p>Leads regular meetings for one grade-level den and guides Scouts through their handbook adventures.</p></div>
        <div class="role-def"><h4>Assistant Den Leader</h4><p>Helps the den leader manage the den and supervise activities.</p></div>
        <div class="role-def"><h4>Committee Chair</h4><p>Leads the pack committee, recruits qualified volunteers, and handles administration.</p></div>
        <div class="role-def"><h4>Chartered Organization Representative</h4><p>The direct liaison between the pack and our sponsoring organization, American Legion Post 409. Approves every registered adult leader.</p></div>
    </div>

    <h3 style="margin-top:2.25rem">Running the pack</h3>
    <p class="muted">The committee. Mostly behind the scenes, mostly a few hours a month.</p>
    <div class="role-defs">
        <div class="role-def"><h4>Treasurer</h4><p>Manages the pack budget, accounts, and finances.</p></div>
        <div class="role-def"><h4>Secretary</h4><p>Takes meeting notes and handles pack correspondence.</p></div>
        <div class="role-def"><h4>Advancement Chair</h4><p>Tracks Scout achievements and organizes badge and rank awards.</p></div>
        <div class="role-def"><h4>Popcorn Kernel</h4><p>Coordinates the annual product sale and money-earning projects.</p></div>
        <div class="role-def"><h4>Camp Coordinator</h4><p>Runs summer camp: sign-ups, forms, packing lists, and the week itself.</p></div>
        <div class="role-def"><h4>Special Event Coordinators</h4><p>Run a single annual tradition, like the Pinewood Derby or the Blue and Gold banquet. One event, once a year, then you are done.</p></div>
    </div>

    <p style="margin-top:1.75rem"><strong>Every one of these is a parent who said yes once.</strong>
       Training is free, mostly online, and nobody expects you to know anything on day one.
       <a href="register.html#adult">Start the adult application</a> or just tell a Cubmaster you are interested.</p>
  </div>
</section>
